...
func djiModelFromManufacturerData(data: Data) -> SettingsDjiDeviceModel {
    ...
    switch data[2 ... 3] {
    case djiDeviceModelOsmoAction2:    return .osmoAction2
    case djiDeviceModelOsmoAction3:    return .osmoAction3
    case djiDeviceModelOsmoAction4:    return .osmoAction4
    case djiDeviceModelOsmoPocket3:    return .osmoPocket3
    case djiDeviceModelOsmoAction5Pro: return .osmoAction5Pro
    case djiDeviceModelOsmo360:        return .osmo360
    case djiDeviceModelOsmoAction6:    return .osmoAction6
