//
//  TVUIRLWindowAckMessage.m
//  DJIStreamDemo
//

#import "TVUIRLWindowAckMessage.h"

@implementation TVUIRLWindowAckMessage

- (instancetype)init {
    return [super initWithType:TVUIRLMessageTypeWindowAck];
}

- (instancetype)initWithSize:(uint32_t)size {
    if (self = [super initWithType:TVUIRLMessageTypeWindowAck]) {
        _size = size;
    }
    return self;
}
